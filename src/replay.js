...
REASONING: IV Crush风险高，原始看空信号被折减至37，低于执行阈值60。建议等待期权IV消化（约30-60分钟）后重新评估，届时信号可能重新激活做空策略。`
  ...
  tsla_q1_2024: {
    id: 'tsla_q1_2024',
    name: 'TSLA Q1 2024 财报 (2024-04-23) 🔴 空头信号',
    ticker: 'TSLA',
    symbol: 'TSLAONUSDT',
    tokenPrice: 168.00,
    epsActual: 0.45,
    ...
    epsSuprise: -13.5,
    revenueActual: 21.30,
    revenueEstimate: 22.27,
    revenueSurprisePct: -4.4,
    ivCrushRisk: false,   // ← IV 正常，不折减 → 触发 SELL 执行
    summary: {
      headline: 'TSLA Q1 2024 双重重大失误，做空信号激活',
      eps: 'EPS $0.45 vs 预期 $0.52（-13.5% 大幅不及预期）',
      revenue: '营收 $21.30B vs 预期 $22.27B（-4.4% 大幅不及预期）',
      guidance: '交付量 386,810 vs 预期 457,000（-15.3%），自由现金流转负 -$25亿'
    },
    fundamentalData: `Tesla Q1 2024 Earnings Results

Revenue: $21.30 billion (-8.7% YoY) — MISS vs estimate $22.27B (-4.4%)
Automotive Revenue: $17.39B vs estimate $18.56B — MISS (-6.3%)

Non-GAAP EPS: $0.45 vs estimate $0.52 (-13.5% MISS — worst in 7 quarters)
GAAP EPS: $0.34

Gross Margin: 17.4% vs estimate 18.3% — MISS (4th consecutive quarter of decline: 20.2%→19.3%→17.9%→17.4%)
Operating Margin: 5.5% (vs 11.4% in Q1 2023) — severe compression

Vehicle Deliveries: 386,810 vs estimate 457,000 — MISS (-15.3%, worst miss since 2019)
Price cuts across all models failed to stimulate expected volume uptick.
Full year delivery guidance: quietly revised significantly lower

Free Cash Flow: -$2.53 billion (first negative FCF in years)
Cash used for CapEx: $2.77B (AI data center + Gigafactory expansion)

Energy & Storage: $1.64B vs estimate $2.6B — massive miss

Core takeaway: Price-cut-driven demand strategy is failing.
Demand destruction confirmed at current price points.`,

    sentimentData: `Tesla CEO Elon Musk Q1 2024 Earnings Call Key Statements:

"The macroeconomic environment is challenging. High interest rates are suppressing EV demand."

"We're accelerating our affordable model timeline for H2 2024."

"FSD will generate substantial revenue as autonomy regularity improves."

"The delivery miss reflects planned factory shutdowns AND demand headwinds."

CFO Vaibhav Taneja: "We're investing heavily in AI and future capacity,
which creates near-term margin pressure that is deliberate."

Management tone: DEFENSIVE — worst in 6 quarters
Risk language density (record high): "macro/macroeconomic" 12x, "challenging" 7x,
  "uncertain" 5x, "headwinds" 6x, "pressure" 9x
Elon deflection count: 8 pivots to future products (FSD, Robotaxi, Optimus, affordable model)
Historical comparison: Similarly defensive tone in Q1 2019 preceded further 20% decline.

Critical signal: NO quantified recovery guidance for deliveries or margin.
Management credibility gap: Cannot explain when price-cut strategy starts working.`,

    historicalComps: [
      { event: 'TSLA Q2 2024 (Jul 2024)', surprise: '-16.1%', priceChange4h: '-4.5%' },
      { event: 'TSLA Q4 2023 (Jan 2024)', surprise: '-10.5%', priceChange4h: '-8.7%' },
      { event: 'TSLA Q2 2023 (Jul 2023)', surprise: '-15.2%', priceChange4h: '-6.1%' }
    ],

    candles: generateCandles(168.00, 24, 'bearish'),

    mockAgentAnalysis: {
      fundamental: `分析 TSLA Q1 2024 财报基本面：

双重重大失误：EPS $0.45 vs $0.52（**-13.5%**），营收 $21.30B vs $22.27B（-4.4%）。

最致命信号是交付量：**386,810辆 vs 预期 457,000辆，缺口达 -15.3%**，是特斯拉近5年最大交付量缺口。降价幅度已超过市场需求弹性——降价换量逻辑彻底失效。

毛利率 17.4%：**连续第四季度下行**（20.2%→19.3%→17.9%→17.4%），没有任何拐点迹象。自由现金流 -$25亿，是数年来首次转负。

指引：全年交付量目标被悄然大幅下调，但管理层回避具体数字——这本身就是最强烈的警示信号。

综合评估：基本面全面恶化，无结构性亮点。空头信号强烈。

SCORE: -84`,

      sentiment: `分析 TSLA 管理层语气和财报情绪信号：

本季度是近6季度语气最防御的财报会议。关键词密度："macro" 12次、"challenging" 7次、"uncertain" 5次、"headwinds" 6次、"pressure" 9次——全部创6季度新高。

Musk 在60分钟会议中8次主动转向未来产品（FSD、Robotaxi、Optimus、廉价车型），是典型的"逃跑式沟通"——当管理层无法解释当下，就描绘未来。

最危险的沉默：CFO 对下季度交付量和毛利率改善**完全没有量化指引**。这在业绩正常的季度从未发生，意味着管理层自己也不确定回升时间节点。

历史对比：2019年Q1 TSLA管理层措辞同样防御，随后股价再跌20%。

SCORE: -76`,

      technical: `分析 TSLAONUSDT 技术面与历史财报后走势：

历史同类事件（EPS miss ≥10% + 交付量大幅缺口）：
• Q4 2023 (Jan 24): -8.7%（4小时，EPS miss -10.5%）
• Q2 2023 (Jul 19): -6.1%（4小时，EPS miss -15.2%）
• Q2 2024 (Jul 23): -4.5%（4小时，但被IV Crush压制）
→ **历史平均 4小时跌幅：-6.4%，方向一致性 100%**

当前 TSLAONUSDT @ $168.00，财报前5天已下跌约 -3.2%（市场有所预期，但远不充分），潜在下行空间仍大。

**IV 风险：LOW** — 期权市场未见异常IV抬升，IV Crush不触发，空头信号完全有效，无折减。

止损价: $172.16（+2.5%），止盈价: $162.12（-3.5%）。
...
方向一致性：**100%（三路全部看空）**
分歧程度：最大差距12分，属正常范围
**IV Crush 风险：LOW — 空头信号完全有效，无折减**

情绪温度计最终读数：
加权均值 = (84×0.40 + 76×0.35 + 72×0.25) = **-78**

决策：信号强度 78 >> 阈值 60，方向高度一致，IV无风险，批准做空。

FINAL_SCORE: -78
ACTION: SELL
POSITION_SIZE: 75
REASONING: 三路信号高度一致指向做空，EPS+交付量双重重大失误，历史同类事件4小时下跌方向一致性100%，IV Crush风险低，信号完全有效，批准开空仓75%。`
    }
  },
